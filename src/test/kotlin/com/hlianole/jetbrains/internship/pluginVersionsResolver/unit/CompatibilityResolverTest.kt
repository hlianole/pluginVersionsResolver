...
class CompatibilityResolverTest {
    ...
    fun shouldReturnNewestVersion() {
        val result = CompatibilityResolver.resolve(plugins[2], null, null)
    ...
    fun shouldReturnSpecificVersion() {
        val result = CompatibilityResolver.resolve(plugins[2], "macos", "arm64")
    ...
    fun shouldReturnOlderVersion() {
        val result = CompatibilityResolver.resolve(plugins[2], "linux", "arm64")
    ...
    fun shouldReturnTheOldestVersion() {
        val result = CompatibilityResolver.resolve(plugins[2], "WINDOWS", null)
    ...
    fun shouldReturnNull() {
        val result = CompatibilityResolver.resolve(plugins[3], "MACOS", null)
